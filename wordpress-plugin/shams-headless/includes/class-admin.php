...
class Shams_Admin {
    ...
    public function render_page() {
        ...
        $endpoints = [
            ...
            'GET /shams/v1/customer/wishlist' => 'Get saved products',
            'POST /shams/v1/customer/wishlist' => 'Add to wishlist',
            'DELETE /shams/v1/customer/wishlist/{id}' => 'Remove from wishlist',
