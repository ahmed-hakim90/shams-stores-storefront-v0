...
export function ProductCardSkeleton() {
  return (
    <div className="grid min-h-[210px] grid-cols-[minmax(120px,38%)_minmax(0,1fr)] overflow-hidden rounded-xl border border-border bg-card sm:grid-cols-[220px_minmax(0,1fr)]" aria-hidden="true">
      ...
      <div className="flex min-w-0 flex-col gap-3 p-3 sm:p-5">
        ...
        <div className="mt-auto flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><Skeleton className="h-6 w-28" /><Skeleton className="h-11 w-full rounded-lg sm:w-44" /></div>
      </div>
    </div>
  )
}
