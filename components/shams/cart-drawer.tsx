...
export function CartDrawer() {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-0 right-0 z-[101] flex h-dvh w-full max-w-md flex-col overflow-hidden bg-background shadow-2xl transition-transform duration-200 ${open ? 'translate-x-0' : 'pointer-events-none translate-x-full'}`} role="dialog" aria-modal="true" aria-label="Shopping cart" aria-hidden={!open}>
