...
export function ProfileSection({ user, logout, updateProfile, changePassword }: {
  user: NonNullable<ReturnType<typeof import('@/components/shams/providers/auth-provider').useAuth>['user']>
  logout: () => void
  updateProfile: ReturnType<typeof import('@/components/shams/providers/auth-provider').useAuth>['updateProfile']
  changePassword: ReturnType<typeof import('@/components/shams/providers/auth-provider').useAuth>['changePassword']
}) {
