              ...
              <div className="flex flex-wrap gap-1.5">
                {subcategoryColumn.links.map((link) => (
                  <Link
                    ...
                    href={link.href}
                    className="border border-border px-2 py-0.5 text-[11px] text-muted-foreground transition-colors hover:border-foreground hover:text-brand-ink"
                  >
                    {link.label}
                  </Link>
                ))}
