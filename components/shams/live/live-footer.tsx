      ...
      <div className="shams-container border-t border-border/60 py-5">
        <div className="flex flex-wrap items-center gap-x-5 gap-y-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex h-7 items-center rounded border border-border bg-white px-2">
            ...
            <span className="inline-flex h-7 items-center gap-1 rounded border border-border bg-white px-2 text-[0.55rem] font-bold tracking-tight text-foreground/70">
              InstaPay
            </span>
            <span className="inline-flex h-7 items-center gap-1 rounded border border-border bg-white px-2 text-[0.55rem] font-bold tracking-tight text-foreground/70">
              Cash
