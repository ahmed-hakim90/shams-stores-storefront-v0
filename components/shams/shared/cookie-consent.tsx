...
export function CookieConsent() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-4 bottom-[calc(1rem+var(--mobile-bottom-nav-height))] z-[120] mx-auto max-w-lg animate-in fade-in-0 slide-in-from-bottom-4 duration-300 sm:bottom-4"
    >
