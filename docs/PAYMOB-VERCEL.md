...
تم نشر الواجهة وإعداد متغيرات Production ومفاتيح Paymob Live، مع إبقاء بوابتي checkout وPaymob مقفولتين. [تقرير النشر والفحوص](VERCEL-RELEASE-2026-09-19.md) هو مرجع الحالة الأحدث؛ ملاحظات عدم النشر أدناه تصف مرحلة التنفيذ السابقة.
